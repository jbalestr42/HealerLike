...
{
    public class StoneTerrainClump : MonoBehaviour
    {
        ...
        [SerializeField] TrampleZone _trample;
        ...
        public StoneAssembly assembly { get { return _assembly; } }
        ...
        public void Init(uint seed, float cellSize, StoneEffects effects, ZoneRegistry zones)
        {
            ...
            StoneRandom random = new StoneRandom(StoneSeed.ForPart(seed, 401));
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                recipe.shape = StonePresets.Shape(size, elongation, random.Range(0.6f, 1f), 0.16f, 0);
                ...
                StoneAssembly.Part part = _assembly.parts[i];
            ...
            if (_trample != null)
            {
                ...
                _trample.radius = TrampleZone.TrampleRadius(bareGroundRadius);
                _trample.Init(zones);
            }

            if (StoneLifeState.Ochre(seed))
            {
                CreateFace();
            }
        }
        ...
        void CreateFace()
        {
            ...
            StoneAssembly.Part part = _assembly.parts[0];
            ...
            block.SetVector("_BaseColor", StoneAssembly.Palette[3].linear);
