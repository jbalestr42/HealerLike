...
namespace HealerLike.Render.Grass
{
    public static class HLGrassBounds
    {
        ...
        {
            bool isFootprintValid = HLGrassLayout.IsValid(width, height, cellSize, gridOrigin, surfaceY);
            ...
            Vector3 center = new Vector3(gridOrigin.x, surfaceY + HLGrassLayout.RootLift, gridOrigin.z);
