...
{
    [Test]
    public void AimPointsTheLightAlongTheStoneShadowDirection()
    {
    ...
    [Test]
    public void RealShadowsNeedPipelineShadowsLightShadowsAndDistance()
    {
    ...
    [Test]
    public void CheapEllipsesTurnOffWithRealShadowsAndBackOnWithout()
    {
