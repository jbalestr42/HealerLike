...
{
    public class LookFillShaderTests
    {
        ...
        public void Render_WorkingSpaceColourVector_ReachesPrimitiveShaderUnchanged()
        {
            ...
            Color a = LookShaderProbe.ReadCentre(_scene, surface, artistColor);
            Color b = LookShaderProbe.ReadCentre(_scene, surface, linearColor);
            Color c = LookShaderProbe.ReadCentre(_scene, surface, linearVector);
        ...
        public void Render_SubPixelHatch_FadesWhileResolvedStrokesRemain()
        {
            ...
            MeshRenderer surface = LookShaderProbe.BuildLitQuad(_scene, 60f);
            ...
            LookShaderProbe.ReadCentre(_scene, surface, white);
