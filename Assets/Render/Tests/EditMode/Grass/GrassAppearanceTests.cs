...
public class GrassAppearanceTests
{
    [UnityTest]
    public IEnumerator CaptureCarpetAndFeedbackFixtureOnMetal()
    {
        ...
        var owners=Object.FindObjectsByType<LookController>(FindObjectsSortMode.None).Where(c=>c.enabled).ToArray();
        ...
        try
        {
            ...
            registry.Add(ZoneKind.Heal,new Vector3(-1.7f,0,-1.2f),1.3f,1);
            registry.Add(ZoneKind.Hostile,new Vector3(1.7f,0,-.9f),1.2f,.85f);
