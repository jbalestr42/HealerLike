...
public class HLHealPulseTests
{
    ...
    public void SetUp()
    {
        ...
        _zones = _zonesGo.AddComponent<HLZoneRegistry>();
        _zones.Init(new HLZoneFakeUpload());
    ...
    public void NotifyHeal_Heal_PulsesOnTheTargetInCellUnitsThenExpires()
    {
        ...
        Assert.AreEqual((int)HLZoneKind.Heal, _zones.snapshot[0].kind);
    ...
    {
        HLRenderRegistry other = new HLRenderRegistry();
