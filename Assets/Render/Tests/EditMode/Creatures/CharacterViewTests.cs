    ...
    public class CharacterViewTests
    {
        ...
        public void CharacterViewUsesAnchorAndRegistryWithoutEntityOrCharacterInit()
        {
            ...
            try
            {
                ...
                CharacterView view = anchor.AddComponent<CharacterView>();
                ...
                rig.Tick(1f, 0.3f, new FootFrame(anchor.transform.position, Vector3.up, 1f));
                rig.Tick(1.3f, 0.3f, new FootFrame(anchor.transform.position, Vector3.up, 1f));
                registry.NotifyHeal(go, target, 4f, true);
                Assert.AreEqual(0, rig.activeArmCount);
                view.enabled = true;
            ...
            {
                CharacterView view = anchor.GetComponent<CharacterView>();
                if (view)
                {
        ...
        public void RegisteredCharacterOutcomesManaAnchorsAndNoGlobalDiscovery()
        {
            ...
            try
            {
                ...
                ResourceOutcomeObserver observer = target.AddComponent<ResourceOutcomeObserver>();
