...
namespace HealerLike.Render.Spells.Studio
{
    ...
    public sealed class SpellStudioPreset : ScriptableObject
    {
        ...
        public bool UsesGameplayOverride => mode == SpellStudioMode.GameplayHandler && useGameplayOverrides &&
            sourceHandler != null && spellLooks != null && spellLooks.buffs != null && spellLooks.buffs.ContainsKey(sourceHandler);
        ...
        bool Resolve(out EffectChannels channels, out EffectElement resolvedElement)
        {
            ...
            if (safeMode == SpellStudioMode.GameplayHandler)
            {
                ...
                SpellLook row = useGameplayOverrides && spellLooks != null && spellLooks.buffs != null && spellLooks.buffs.ContainsKey(sourceHandler) ? spellLooks.buffs[sourceHandler] : null;
                if (row != null)
                {
        ...
        public string[] Validate()
        {
            ...
            if (source != null)
            {
                ...
                if (!Enum.IsDefined(typeof(EffectMotionKind), source.motion) || !Enum.IsDefined(typeof(EffectSocket), source.socket) ||
