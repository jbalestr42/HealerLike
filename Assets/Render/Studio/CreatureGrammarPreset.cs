        ...
        public string[] Validate()
        {
            ...
            if (plant)
            {
                ...
                if (vocabulary.rootCount < 4 || vocabulary.rootCount > 14 || vocabulary.armCount < 0 ||
                    vocabulary.armCount > HealerLike.Render.Deliveries.ArmPool.MaxArms || !Positive(vocabulary.rootHip) ||
            ...
            if (c.accessory != AccessoryKind.None)
            {
                ...
                if (LookMeasure.AccessoryReach(finalChannels, vocabulary) < minimum)
