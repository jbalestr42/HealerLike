...
namespace HealerLike.Render.Studio.Editor
{
    public sealed partial class CreatureStudioWindow
    {
        ...
        {
            if (grammarSelected==null) return;
            string path=EditorUtility.SaveFilePanelInProject("Save creature grammar preset",GrammarLabel(grammarSelected),"asset","Save the editable channels and vocabulary reference.","Assets/Render/Studio/Data/Presets");
