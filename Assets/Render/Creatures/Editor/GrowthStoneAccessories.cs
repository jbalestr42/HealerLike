    ...
    public static class GrowthStoneAccessories
    {
        public static LookVocabulary.AccessoryEntry Build(AccessoryKind kind)
        {
            return new LookVocabulary.AccessoryEntry
            {
                ...
                isCentered =
                    kind == AccessoryKind.TierRings
                    || kind == AccessoryKind.SmallTorus
                    || kind == AccessoryKind.ThornCollar
                    || kind == AccessoryKind.ConeCrown
                    || kind == AccessoryKind.TwinSeeds
                    || kind == AccessoryKind.ShardBarbs,
                miniHeadAt = new Vector3(1.75f, 0.42f, 0f),
                miniHeadScale = 0.46f,
        ...
        static LookPart[] Build(AccessoryKind kind, bool stone)
        {
            ...
            switch (kind)
            {
                ...
                case AccessoryKind.Hook:
                    ...
                    parts.Add(
                        Link("HookBend", stalk, new Vector3(1.0f, 0.08f, 0f), new Vector3(1.32f, 0.48f, 0f), 0.2f)
                    );
                    parts.Add(
                        Part(
                            "HookTip",
                            thorn,
                            new Vector3(1.28f, 0.73f, 0f),
                            new Vector3(0.25f, 0.49f, 0.22f),
                ...
                case AccessoryKind.Antenna:
                    ...
                    parts.Add(
                        Part("AntennaSeed", seed, new Vector3(1.14f, 1.26f, 0f), new Vector3(0.25f, 0.35f, 0.24f))
                    );
                    break;
                case AccessoryKind.ThornCollar:
                    ...
                    for (int i = 0; i < 6; i++)
                    {
                        ...
                        parts.Add(
                            Link(
                                "Thorn",
                                stone ? thorn : ShapeProfile.Segment(0.92f, 0.08f),
                                from,
                                to,
                                stone ? 0.14f : 0.10f
                            )
                ...
                case AccessoryKind.TierRings:
                    for (int i = 0; i < 3; i++)
                    {
                        parts.Add(
                            Part(
                                "TierRing",
                                ShapeProfile.Ring(0.24f, stone),
                                new Vector3(0f, stone ? 0.02f - i * 0.22f : -0.04f - i * 0.14f, 0f),
                                stone
                                    ? new Vector3(1.25f + i * 0.15f, 0.12f, 1f + i * 0.12f)
                    ...
                    for (int side = -1; side <= 1; side += 2)
                    {
                        parts.Add(
                            Link(
                                ...
                                stalk,
                                Vector3.zero,
                                new Vector3(side * (stone ? 0.43f : 0.5f), stone ? -0.32f : -0.2f, 0f),
                                0.12f
                            )
                        );
                        parts.Add(
                            Part(
                                ...
                                new Vector3(0.34f, stone ? 0.66f : 0.56f, 0.35f),
                                euler: new Vector3(0f, 0f, -side * 22f)
                            )
                        );
                    }
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        parts.Add(
                            Part(
                                "StalkBead",
                                seed,
                                new Vector3(0.82f + i * 0.11f, 0.3f + i * 0.29f, 0f),
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        parts.Add(
                            Part(
                                "CrownCone",
                                thorn,
                                new Vector3((i - 1) * 0.25f, 1.08f, 0f),
                ...
                case AccessoryKind.DripBeads:
                    parts.Add(
                        Link("DripBeam", stalk, new Vector3(0.05f, 0.3f, 0f), new Vector3(1.43f, 0.38f, 0f), 0.15f)
                    );
                    for (int i = 0; i < 3; i++)
                    {
                ...
                case AccessoryKind.ShardBarbs:
                    for (int side = -1; side <= 1; side += 2)
                    {
                        parts.Add(
                            Part(
                                "ShardBarb",
                                stone ? ShapeProfile.Shard() : ShapeProfile.Leaf(0.2f, 0.55f),
                                new Vector3(side * 0.48f, 0.26f, 0f),
                                new Vector3(0.3f, 0.98f, 0.26f),
                    ...
                    break;
                default:
                    Debug.LogError("[GrowthStoneAccessories] No accessory fragment.");
