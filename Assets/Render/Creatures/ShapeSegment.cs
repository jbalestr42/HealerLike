...
namespace HealerLike.Render.Creatures
{
    public struct ShapeSegment
    {
        ...
        public static ShapeSegment Fit(
            Vector3 bottom,
            Vector3 top,
            Vector3 from,
            Vector3 to,
        ...
        )
        {
            ...
            if (overlap > 0f)
            {
                span = delta.magnitude + overlap;
                lengthSquared = span * span;
            }
            ...
            {
                width = overlap > 0f ? span / Mathf.Sqrt(lateral) * 0.99f : Mathf.Sqrt(lengthSquared / lateral) * 0.99f;
            }
