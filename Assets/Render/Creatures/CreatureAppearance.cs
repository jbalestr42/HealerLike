...
namespace HealerLike.Render.Creatures
{
    ...
    {
        public const float PieceDuration = 0.32f;
        ...
        public static float PartDelay(PartRole role, float height)
        {
            ...
            switch (role)
            {
                case PartRole.Limb: return height * 0.08f;
                case PartRole.Body: return 0.12f + height * 0.08f;
                case PartRole.Stem: return 0.17f + height * 0.14f;
                case PartRole.Head: return 0.28f + height * 0.17f;
                case PartRole.Tip: return 0.48f + height * 0.15f;
                default: return 0.36f + height * 0.17f;
            }
        }
